...
export class PassComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: Pass) {
        return item.id;
    }
    registerChangeInPasses() {
        this.eventSubscriber = this.eventManager.subscribe('passListModification', (response) => this.reset());
    }
